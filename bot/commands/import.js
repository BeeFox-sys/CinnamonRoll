...
module.exports = {
	...
	async execute(client, guildSettings, msg, args) {
		...
		if (attachments.length != 1 || !attachments[0].name.toUpperCase().endsWith(".JSON")) return msg.channel.send(utils.errorEmbed("You must attach only one file from either Tupperbox, CinnamonRoll, or PluralKit"))
		if (attachments[0].size > 8 * 1024 ** 2) {
